...
namespace BitCar {
    ...
    */
    ...
    //% block="BitCar: 立ちあがる　スピード: $speed \\% 時間:$charge|(ms)"
    //% speed.defl=100
    ...
    */
    //% blockId=linefollow
    //% block="BitCar: 線についていく　スピード:  $speed \\%"
    //% speed.defl=50
    //% speed.min=0 speed.max=100
    //% group="BitCar Control"
    //% weight=96
    ...
    */
    ...
    //% block="超音波センサー $groveport|: 距離 in $Unit"
    //% group="Sensors"
    //% weight=100
    ...
    */
    ...
    //% block="(V2)超音波センサー $groveport|: 距離: $Unit"
    //% group="Sensors"
    //% weight=99
